    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 sm:gap-16 mb-14 sm:mb-24 text-left">
        <div className="max-w-4xl">
          <p className="theme-accent text-[11px] font-black uppercase tracking-[0.4em] mb-5">
            Precision Layer
          </p>
        ...
        <div className="theme-surface-accent w-full lg:w-auto border px-8 py-8 sm:px-10 sm:py-10 rounded-4xl sm:rounded-[2.5rem] shadow-2xl transition-colors">
          <p className="text-[12px] font-black uppercase tracking-[0.35em] theme-accent mb-3 leading-none">
            Compliance Protocol
          </p>
