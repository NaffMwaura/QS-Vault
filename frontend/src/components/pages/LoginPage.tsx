...
const FeatureItem = ({ icon: Icon, title, description }: any) => (
  <div className="flex items-start gap-5 group">
    <div className={`p-3 theme-card transition-all duration-500 group-hover:scale-110 text-[var(--app-accent-strong)]`}>
      <Icon size={20} />
    </div>
    <div className="text-left">
      <h4 className={`text-xs font-bold uppercase tracking-widest text-[var(--app-heading)]`}>
        {title}
      </h4>
      <p className={`text-[11px] font-medium leading-relaxed mt-1 text-[var(--app-meta)]`}>
        {description}
      </p>
    </div>
  </div>
...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen w-full flex flex-col lg:flex-row font-sans selection:bg-amber-500/30 transition-colors duration-500 theme-page`}>
      
      {/* 1. LEFT SECTION: BRANDING & INFO */}
      <div className={`relative flex-1 p-8 lg:p-16 flex flex-col justify-between border-r transition-all duration-500 bg-[var(--app-bg)] border-[var(--app-border)]
        ...
        <div className="relative z-10 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setMobileView("form")} className={`lg:hidden p-3 rounded-2xl bg-[var(--app-surface)] text-[var(--app-meta)] border border-[var(--app-border)]`}><ChevronRight size={18} /></button>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-12">
          <div className="space-y-6">
            <div className="flex items-center gap-5">
              ...
              <h1 className={`text-3xl font-black uppercase tracking-tighter italic text-[var(--app-heading)]`}>QS VAULT<span className="text-amber-500">.</span></h1>
            </div>

            <h2 className={`text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-tight italic text-[var(--app-heading)]`}>
              Site Mastery <br />
        ...
        <div className={`relative z-10 flex items-center justify-between border-t pt-10 border-[var(--app-border)]`}>
          <div className="flex items-center gap-4">
            <Ruler size={16} className={'text-[var(--app-meta)]'} />
            <p className={`text-[10px] font-bold uppercase tracking-[0.5em] text-[var(--app-meta)]`}>PRO VERSION 2.5</p>
          </div>
          <button onClick={toggleTheme} className={`p-3 rounded-xl border transition-colors theme-card hover:text-[var(--app-accent-strong)] text-[var(--app-meta)]`}>
      ...
      <div className={`flex-1 p-8 lg:p-16 flex items-center justify-center relative overflow-y-auto custom-scrollbar bg-[var(--app-bg)]
          ...
          <div className={`transition-all duration-500`}>
            ...
            <div className="flex justify-between items-start mb-10">
              <div className="text-left space-y-2">
                <h3 className={`text-2xl font-black uppercase tracking-tighter italic text-[var(--app-heading)]`}>
              ...
              <button onClick={() => setMobileView("branding")} className={`lg:hidden p-3 rounded-2xl bg-[var(--app-surface)] text-[var(--app-meta)] border border-[var(--app-border)]`}><Info size={24}/></button>
            </div>
            ...
            <form onSubmit={handleAuth} className="space-y-6">
              {isRegistering && (
                <div className="space-y-3 text-left">
                  <label className={`text-xs font-bold uppercase tracking-widest ml-5 text-[var(--app-meta)]`}>Username</label>
                  <div className="relative group">
                    <User size={20} className="absolute left-7 top-1/2 -translate-y-1/2 text-[var(--app-meta)] group-focus-within:text-[var(--app-accent-strong)] transition-colors" />
                    <input
              ...
              <div className="space-y-3 text-left">
                <label className={`text-xs font-bold uppercase tracking-widest ml-5 text-[var(--app-meta)]`}>Email Address</label>
                <div className="relative group">
                  <Mail size={20} className="absolute left-7 top-1/2 -translate-y-1/2 text-[var(--app-meta)] group-focus-within:text-[var(--app-accent-strong)] transition-colors" />
                  <input
              ...
              <div className="space-y-3 text-left">
                <label className={`text-xs font-bold uppercase tracking-widest ml-5 text-[var(--app-meta)]`}>Password</label>
                <div className="relative group">
                  <Lock size={20} className="absolute left-7 top-1/2 -translate-y-1/2 text-[var(--app-meta)] group-focus-within:text-[var(--app-accent-strong)] transition-colors" />
                  <input
                  ...
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-7 top-1/2 -translate-y-1/2 text-[var(--app-meta)] hover:text-[var(--app-accent-strong)] transition-colors">
            ...
            <div className="mt-10 space-y-6 text-center">
               <button
                ...
                <div className="flex items-center gap-6 opacity-20">
                  ...
                  <span className={`text-[10px] font-black uppercase tracking-widest text-[var(--app-heading)]`}>Or continue with</span>
                  <div className={`h-px flex-1 bg-[var(--app-border)]`} />
                </div>
